using Simplify.ORM.PostgresSQL;
using Simplify.ORM.SQLServer;

namespace Simplify.ORM.Test.PostgresSQL
{
    public class SimplifyPostgresqlSQLQueryTest
    {
        [Fact]
        public void SelectFieldsTest()
        {
            ...
            var query = new SimplifyPostgresSQLQuery()
